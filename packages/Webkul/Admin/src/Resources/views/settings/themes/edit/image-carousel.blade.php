                ...
                <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                    <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                        ...
                        >
                            ...
                            <input
                                type="hidden"
                                :name="'{{ $currentLocale->code }}[options]['+ index +'][desc]'"
                                :value="image.desc"
                            />
                            <input
                                type="hidden"
                                :name="'{{ $currentLocale->code }}[options]['+ index +'][title_color]'"
                                :value="image.title_color"
                            />
                            <input
                                type="hidden"
                                :name="'{{ $currentLocale->code }}[options]['+ index +'][desc_color]'"
                                :value="image.desc_color"
                            />
                    ...
                    <x-admin::modal ref="addSliderModal">
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    type="color"
                                    name="{{ $currentLocale->code }}[title_color]"
                                    rules="required"
                                    :placeholder="'Header Text Color'"
                                    :label="'Header Text Color'"
                                />

                                <x-admin::form.control-group.error control-name="{{ $currentLocale->code }}[title_color]" />
                            </x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    type="text"
                                    name="{{ $currentLocale->code }}[desc]"
                                    rules="required"
                                    :placeholder="'Description'"
                                    :label="'Description'"
                                />

                                <x-admin::form.control-group.error control-name="{{ $currentLocale->code }}[desc]" />
                            </x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    type="color"
                                    name="{{ $currentLocale->code }}[desc_color]"
                                    rules="required"
                                    :placeholder="'Description Text Color'"
                                    :label="'Description Text Color'"
                                />

                                <x-admin::form.control-group.error control-name="{{ $currentLocale->code }}[desc_color]" />
                            </x-admin::form.control-group>
                ...
                saveSliderImage(params, { resetForm ,setErrors }) {
                    ...
                    try {
                        ...
                        this.sliders.images.push({
                            ...
                            title_color: formData.get("{{ $currentLocale->code }}[title_color]"),
                            desc: formData.get("{{ $currentLocale->code }}[desc]"),
                            desc_color: formData.get("{{ $currentLocale->code }}[desc_color]"),
                        ...
                        agree: () => {
                            ...
                            this.sliders.images = this.sliders.images.filter(item => {
                                return (
                                    ...
                                    item.desc !== image.desc ||
                                    item.title_color !== image.title_color ||
                                    item.desc_color !== image.desc_color ||
