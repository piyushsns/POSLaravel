    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::prefix('data-transfer')->group(function () {
            ...
            Route::controller(ImportController::class)->prefix('imports')->group(function () {
                ...
                Route::post('/upload_products_images', 'uploadProductImages')->name('admin.settings.data_transfer.imports.upload_products.images');

                Route::post('/upload_products_videos', 'uploadProductVideos')->name('admin.settings.data_transfer.imports.upload_products.videos');
